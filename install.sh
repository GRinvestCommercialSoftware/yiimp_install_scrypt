...
sudo mysql --defaults-group-suffix=host1 --database=yiimpfrontend --force < 2016-02-18-accounts_donation.sql
sudo mysql --defaults-group-suffix=host1 --database=yiimpfrontend --force < 2016-02-23-shares_diff.sql
