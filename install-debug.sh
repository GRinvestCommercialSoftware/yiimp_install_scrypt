...
################################################################################
    ...
    Q3="FLUSH PRIVILEGES;"
    SQL="${Q1}${Q2}${Q3}"
    sudo mysql -u root -p="" -e "CREATE DATABASE IF NOT EXISTS yiimpy;GRANT ALL ON *.* TO 'panel'@'localhost' IDENTIFIED BY '$password';FLUSH PRIVILEGES;"
    ...
    echo
    echo
    echo -e "$CYAN => Database 'yiimpy' and users 'panel' and 'stratum' created with password $password and $password2, will be saved for you $COL_RESET"
    echo
    ...
    sudo mysql --defaults-group-suffix=host1  --database=yiimpy --force < 2016-04-27-settings.sql
    sudo mysql --defaults-group-suffix=host1  --database=yiimpy --force < 2016-05-11-coins.sql
    sudo mysql --defaults-group-suffix=host1  --database=yiimpy --force < 2016-05-15-benchmarks.sql
    sudo mysql --defaults-group-suffix=host1  --database=yiimpy --force < 2016-05-23-bookmarks.sql
    sudo mysql --defaults-group-suffix=host1  --database=yiimpy --force < 2016-06-01-notifications.sql
    sudo mysql --defaults-group-suffix=host1  --database=yiimpy --force < 2016-06-04-bench_chips.sql
    sudo mysql --defaults-group-suffix=host1  --database=yiimpy --force < 2016-11-23-coins.sql
    sudo mysql --defaults-group-suffix=host1  --database=yiimpy --force < 2017-02-05-benchmarks.sql
    sudo mysql --defaults-group-suffix=host1  --database=yiimpy --force < 2017-03-31-earnings_index.sql
    sudo mysql --defaults-group-suffix=host1  --database=yiimpy --force < 2017-05-accounts_case_swaptime.sql
    sudo mysql --defaults-group-suffix=host1  --database=yiimpy --force < 2017-06-payouts_coinid_memo.sql
    sudo mysql --defaults-group-suffix=host1  --database=yiimpy --force < 2017-09-notifications.sql
    sudo mysql --defaults-group-suffix=host1  --database=yiimpy --force < 2017-10-bookmarks.sql
    sudo mysql --defaults-group-suffix=host1  --database=yiimpy --force < 2017-11-segwit.sql
    sudo mysql --defaults-group-suffix=host1  --database=yiimpy --force < 2018-01-stratums_ports.sql
    sudo mysql --defaults-group-suffix=host1  --database=yiimpy --force < 2018-02-coins_getinfo.sql
    echo -e "$GREEN Done...$COL_RESET"
    ...
    sudo sed -i 's/database = yaamp/database = yiimpy/g' *.conf
